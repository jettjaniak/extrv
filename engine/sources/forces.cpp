...
forces_t forces::shear_forces(double shear_rate, double h, const ModelParameters *p) {
...
double forces::repulsive_force(double h, const ModelParameters *p) {
...
double forces::grav_force(const ModelParameters *p) {
