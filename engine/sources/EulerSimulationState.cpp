...
EulerSimulationState::EulerSimulationState(double h_0, Parameters* p, unsigned int seed, double dt) :
        AbstractConstStepSimulationState(h_0, p, seed, dt) {}

void EulerSimulationState::reset_stepper() {}

// TODO: define one level higher
double EulerSimulationState::do_ode_step() {
