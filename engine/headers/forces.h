...
namespace forces {
     ...
     */
    forces_t non_bond_forces(double shear_rate, double h, const Settings::ModelParameters *p);
     ...
     * @param p model's parameters
     */
    forces_t shear_forces(double shear_rate, double h, const Settings::ModelParameters *p);
     ...
     * @param p model's parameters
     */
    double repulsive_force(double h, const Settings::ModelParameters *p);
     ...
     * @param p model's parameters
     */
    double grav_force(const Settings::ModelParameters *p);
}